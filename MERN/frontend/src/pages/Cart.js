...
const Cart = () => {
    ...
    // Wrap the handleLoading function with useCallback
    const handleLoading = useCallback(async () => {
        await fetchData();
    }, []); // Empty dependency array ensures the function doesn't change on each render
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className='px-4 py-2 relative'>
                                        ...
                                        {product?.productId && <p className='capitalize text-slate-500'>{product?.productId.category}</p>}
